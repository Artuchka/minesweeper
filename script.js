...
const settingsGear = document.querySelector("#settingsGear")
const gameSettingsForm = document.querySelector("#gameSettings")
...
const onchangeMinesLeftEventListener = (e) => {
	minesLeft =
		Math.min(parseFloat(inputMinesLeftElement.value), boardSize ** 2 - 1) ??
		3
...
settingsGear.addEventListener("click", toggleSettings, false)
...
function showModalWin() {
	modalEndgameElement.querySelector(".message").textContent =
		"YOU HAVE WON!!!"
...
function toggleSettings() {
	gameSettingsForm.classList.toggle("hidden")
}
